...
import CreateProject from './layouts/ProjectsList/CreateProject'
...
const Projects = React.lazy(() => import('./layouts/ProjectsList'))
const Organizations = React.lazy(() => import('./layouts/OrganizationsList'))

const Widgets = React.lazy(() => import('./views/widgets/Widgets'))
const projectDetails = React.lazy(() => import('./layouts/ProjectsList/ProjectDetails'))
const EditProject = React.lazy(() => import('./layouts/ProjectsList/EditProject'))
const OrganizationDetails = React.lazy(() => import('./layouts/OrganizationsList/OrganizationDetails'))
...
const routes = [
  ...
  { path: '/theme/typography', name: 'Typography', element: Typography },
    { path: '/projects', name: 'Projects', element: Projects, exact: true },
    { path: '/projects/projectslist', name: 'Projects List', element: ProjectsList },
    { path: '/projects/createproject', name: 'Create Project', element: CreateProject },
    { path: '/projects/:projectKey', name: 'Project Details', element: projectDetails },
    { path: '/projects/edit/:projectKey', name: 'Edit Project', element: EditProject },

    { path: '/oragnizations', name: 'Organizations', element: Organizations, exact: true },
    { path: '/organizations/organizationslist', name: 'Organizations List', element: OrganizationsList },
    { path: '/organizations/createOrganization', name: 'Create Organization', element: CreateOrganization },
    { path: '/organizations/:organizationKey', name: 'Organization Details', element: OrganizationDetails },
